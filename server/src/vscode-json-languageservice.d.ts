...
declare module "vscode-json-languageservice/lib/umd/services/jsonSchemaService" {
  ...
  type SchemaRequestService =
    import("vscode-json-languageservice").SchemaRequestService;
  type WorkspaceContextService =
    import("vscode-json-languageservice").WorkspaceContextService;
  ...
  class JSONSchemaService {
    ...
    getSchemaForResource(
      resource: string,
      document?: JSONDocument
    ): Thenable<ResolvedSchema | undefined>;
    getMatchingSchemas(
